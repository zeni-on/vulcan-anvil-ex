...
ROUTING_DOCS = (
    ...
    ".agents/skills/vulcan-design/references/legacy-gates.md",
    ".agents/skills/vulcan-impl-wave/references/legacy-gates.md",
    ".agents/skills/vulcan-qa/references/legacy-gates.md",
    ".agents/skills/vulcan-release/references/legacy-gates.md",

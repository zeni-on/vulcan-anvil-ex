...
verification_results:
  - id: QA-000-DOCTOR
    ...
    os: windows
    exit_code: 0
    success_criteria: "summary.fail == 0 and JSON checks are readable"
    result: passed
    summary: "doctor JSON produced structured environment readiness evidence; warnings are tracked as QA-000 environment readiness, not product defects."
    log_path: docs/artifacts/04-review/evidence/qa-000/QA-000-doctor.log
    evidence_path: docs/artifacts/04-review/evidence/qa-000/QA-000-doctor.json
  - id: QA-000-GIT
    type: environment
    cwd: repository root
...
evidence:
  documents:
    ...
    - docs/artifacts/04-review/DOC-QA-G4-002_Test-Result_v0.1.md
  files:
    - docs/artifacts/04-review/evidence/qa-000/QA-000-doctor.json
    - docs/artifacts/04-review/evidence/qa-000/QA-000-doctor.log

...
| 5 | `docs/03-test-plan/TEST_PLAN.md` | TST-ID 추가 | QA |
...
| 5 | `docs/03-test-plan/TEST_PLAN.md` | 해당 TST-ID 덮어쓰기 (현재 요구사항 기준) | QA |
...
| 3 | `docs/03-test-plan/TEST_PLAN.md` | 해당 TST-ID 제거 | QA |

...
{PROJECT_NAME}/
  ...
  vulcan.config.json       # L2 Review 등 프로젝트별 실험 기능 설정
...
| `docs/reviews/` | 독립 검수 기록 | L2 Review 요청과 결과 후보를 남깁니다. |
...
python vulcan.py l2-review --gate gate2 --title "Gate 2 설계 독립 검수" --related-ids REQ-001

...
- **Ex Core**: `docs/core/{ID_SYSTEM, TRACEABILITY_RULES, ORCHESTRATOR_PROTOCOL, AGENT_RUN_PROTOCOL, AGENT_PERSONAS, CHANGE_CONTROL_PROCESS, SECURITY_BASELINE, KISA_SECURITY_RULES, DATA_STANDARD_RULES, REFERENCE_STANDARDS, DOCUMENT_METADATA}.md`
...
- `vulcan.py gate-start <gateN>` — 승인된 CR 처리 (이전 `rollback` 명령은 제거됨)

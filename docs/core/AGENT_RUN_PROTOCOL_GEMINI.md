...
* 오케스트레이터는 [RUN_INPUT_CONTRACT.md](RUN_INPUT_CONTRACT.md) 규격에 맞춰 다음 동적 계약을 주입합니다.
...
* 워커는 작업을 완료하고 [RUN_OUTPUT_CONTRACT.md](RUN_OUTPUT_CONTRACT.md) 포맷에 맞춰 완료보고서를 작성 및 반환합니다.

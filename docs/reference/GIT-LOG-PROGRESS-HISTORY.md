...
| 2026-05-29 | 0 | 0 | 0 | 3 | 6 | 1 | trace-context, Dashboard Trace Explorer, release-pr, v0.4.0 릴리즈 |
...
2026-05-29
- feat: move trace context into explorer overlay
- feat: show trace node labels in explorer graph
- release: v0.4.0
```

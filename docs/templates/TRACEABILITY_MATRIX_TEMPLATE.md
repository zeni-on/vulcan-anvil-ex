...
| REQ-ID | NREQ-ID | AC-ID | FUNC-ID | SCR-ID | PGM-ID | DB-ID | IF-ID | SEC-ID | UT-ID | IT-ID | PT-ID | 상태 | 증적 | 비고 |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| REQ-001 |  | AC-001 | FUNC-001 | SCR-001 | PGM-001 | DB-001 |  | SEC-001 | UT-001 | IT-001 |  | Draft |  |  |
...
| SEC-ID | 보안항목 | 관련 REQ/NREQ | 적용 대상 | 검증 테스트 | 증적 | 상태 |
| --- | --- | --- | --- | --- | --- | --- |
| SEC-001 |  | REQ-/NREQ- | SCR-/PGM-/DB- | UT-/IT- |  | Draft |
